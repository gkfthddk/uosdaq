...
//########################################################################
   ...
   fHSlider948->Connect("PositionChanged()","GetCondition::GetCondition",GC,"Slider()");
//TQObject::Connect(fHSlider948,"PositionChanged()","GetCondition",GC,"GC->Slider()");
   ...
   print();
TQObject::Connect(fRunButton,"Clicked()",0,0,"print()");
